...
visaForm.addEventListener('submit', async (e) =>{
  ...
  // files may come from inputs or from capturedBlob
  ...
  if(!frontFile && capturedBlob && currentSide === 'front') frontFile = capturedBlob;
  if(!backFile && capturedBlob && currentSide === 'back') backFile = capturedBlob;
...
captureBtn.addEventListener('click', async () =>{
  ...
  try{
    ...
    if(currentSide === 'front'){
      ...
      // وضع blob في variable عند الإرسال نستخدمها
